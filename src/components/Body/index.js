            ...
            <div className='flex items-center'>
              <div className='flex mr-4 mt-2'>
                <div className='md:hidden m-0 p-0'>
                  <div className='flex items-center'>
                    <div className='font-normal text-sm text-gray-900'>By&nbsp;</div>
                    <a className='no-underline'>
                      <div className='font-semibold text-sm text-gray-900'>CelMatesByMcBess</div>
                    </a>
                ...
                <div className='max-md:hidden m-0 p-0'>
                  <div className='flex items-center'>
                    <div className='font-normal text-base text-gray-900'>By&nbsp;</div>
                    <a className='no-underline'>
                      <div className='font-semibold text-base text-gray-900'>CelMatesByMcBess</div>
                    </a>
                    <a className='text-blue-500'>
                      <SafetyCheckIcon />
                    </a>
      ...
      <div className='py-0 px-4 xl:px-8 2xl:px-16 mx-auto my-0 w-full max-w-[2560px]'>
        <div>
          <div className='my-3 text-gray-900'>
            <span className='whitespace-pre'>Items <span className='font-semibold whitespace-pre'>4,117</span></span>
            &nbsp;&nbsp;·&nbsp;
            <span className='whitespace-pre'>Created <span className='font-semibold whitespace-pre'>Nov 2022</span></span>
            &nbsp;&nbsp;·&nbsp;
            <span className='whitespace-pre'>Creator fee <span className='font-semibold whitespace-pre'>6.9%</span></span>
            &nbsp;&nbsp;·&nbsp;
            <span className='whitespace-pre'>Chain <span className='font-semibold whitespace-pre'>Ethereum</span></span>
          </div>
        </div>
        <div>
          <div className='break-words flex flex-col max-w-full md:max-w-8/10 lg:max-w-6/10 xl:max-w-9/10'>
            <div className='w-full text-gray-900 m-0'>
              <p>Crime reports are used to redeem Cel Mates and enter the hallowed
                halls of the Steel Hose Penitentiary. An exclusive hub for
                counterculture and creatives to gather. 1 CRIME REPORT = 1 CEL MATE.</p>
            </div>
        ...
        <div role='tabpanel'>
            ...
            <div className='w-[calc(100vw-17px)] t-0 h-full shadow-none lg:absolute lg:bg-gray-0 lg:left-[calc((100vw-(100%+17px))/-2)] lg:right-calc((100vw-(100%+17px))/-2)'>
              <div className='h-full'>
                <div className='flex items-center h-full max-w-[2560px] w-full px-4 py-0 xl:px-8 2xl:px-16'>
                  <button onClick={() => setFilterVisible(visible => !visible)}>
                    <FilterListIcon />
                  </button>
          ...
          <div className='md:mt-0 w-full md:flex'>
            <div className='max-md:hidden'>
              <div className={`flex flex-col sticky top-[138px] h-[calc(100vh-138px)] overflow-hidden ${filterVisible ? 'w-[340px] -ml-2.5 mr-4' : 'w-0'}`}>
